---
name: test-stores
description: Guide and patterns for unit testing pure JavaScript/TypeScript state stores (like Zustand, Redux, or Context reducers) using either Vitest or Jest. Use this when writing tests for state management.
---
